...
<style>
/* for automatic dropdown */
li.dropdown:hover>ul.dropdown-menu{display:block; margin:0px;}
</style>
  </head>
<body>
<!-- Header -->
  ...
  <div class="container">
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-lock" ></i> Logout</a></li>
      </ul>
    </div>
  </div><!-- /container -->
</div>
